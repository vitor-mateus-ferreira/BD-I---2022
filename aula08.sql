...
INSERT INTO estado (id,nome, sigla, ativo, data_cadastro) VALUES (1, 'PARANÁ', 'PR', 'S', '2022-09-01'), (2, 'SÃO PAULO','SP', 'S', '2022-09-01'), (3, 'RIO GRANDE DO SUL', 'RS', 'S', '2022-09-01');
...
INSERT INTO estado (nome, sigla, ativo, data_cadastro) VALUES ('MATO GROSSO', 'MT', 'S', '2022-09-01'), ('RIO DE JANEIRO','RJ', 'S', '2022-09-01'), ('GOIAS', 'GO', 'S', '2022-09-01');
...
UPDATE estado SET nome = 'RIO DE JANEIRO', sigla = 'RJ' WHERE nome = 'RIO DE JANEIRO';
SELECT * FROM estado;

-- 12.	Exclua um único registro de uma tabela sem utilizar como filtro, a chave primária.
DELETE FROM cidade WHERE nome = 'RIO DE JANEIRO';
SELECT * FROM cidade;
